        ...
        {expandedEvent === event.id && (
          <div style={styles.userList}>
            ...
            {event.users
              ...
              .map((us) => (
                <div key={us.id} style={styles.userItem}  >
                {/* <div key={us.id} style={styles.userItem} onClick={() => startPrivateChat(us, event)}> */}
                  <Menu
        anchorEl={anchorEl}
        transitionDuration={0}         // ✅ no slow animation
  keepMounted={false} 
        ...
        PaperProps={{
          style: {
            backgroundColor: 'rgba(33, 33, 33, 0.9)',   // Dark background for dropdown
                ...
                {messages.map((msg, index) => {
                    ...
                    <div key={index} style={{ ...styles.messageWrapper, justifyContent: isUser ? "flex-end" : "flex-start" }}>
                        { isUser ? (
                            ...
                            <div style={styles.messageText}>
                                <div style={styles.userBubble} onClick={() => startPrivateChatUserFromGroup(msg)}>
                                    {msg.from.avatar ? (
                                        <img src={BASE_PATH+msg.from.avatar} alt={formattedName} style={styles.avatar} />
                                    ) : (
                                        formattedName.charAt(0)
